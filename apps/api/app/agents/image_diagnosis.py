...
可选的商品标签（仅从以下标签中选择相关的，不要编造）：
皮肤, 猫癣, 真菌, 脱毛, 瘙痒, 红肿, 过敏, 术后, 防舔, 肠胃, 呕吐, 腹泻, 软便, 消化, 处方, 寄生虫, 跳蚤, 蜱虫, 肥胖, 超重, 减肥, 毛球, 营养, 体弱, 术后恢复, 耳朵, 耳螨, 甩头, 异味, 眼睛, 眼部, 流泪, 口腔, 口臭, 呼吸道
...
4. 居家护理建议（2-3条）
5. 是否建议就医（是/否）
6. 推荐商品标签（从上面的标签中选择2-4个最相关的，用逗号分隔，仅输出标签，如：耳朵,耳螨,甩头）"""
